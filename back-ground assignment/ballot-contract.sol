...
contract Ballot {
    ...
    /** 
     * I modified the function to reduce the gas fee by using a for loop to loop through the array of
     addresses that was passed to it and assigning a weight of 1 to each addresses.
     */
